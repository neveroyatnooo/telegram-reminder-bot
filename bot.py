...
def init_db():
    ...
    try:
        ...
        """)
        conn.commit()
        # добавить админов в allowed_users
        if ADMIN_IDS:
            cur.executemany(
            ...
            conn.commit()
        # добавить message_thread_id если нет
        try:
            cur.execute(
        ...
        # проверить наличие message_thread_id
        cur.execute("""
...
if __name__ == "__main__":
    ...
    # Удалять все сообщения пользователей
